...
const error=e=>Message.error({content:e.message||'操作失败',duration:5000});const load=async()=>{try{const r=await employees({keyword:keyword.value,page:1,pageSize:100});items.value=r.data.items}catch(e){error(e)}};
